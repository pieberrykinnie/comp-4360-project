...
def main():
    ...
    parser.add_argument("--csv", required=True, help="Path to CheXpert train.csv")
    parser.add_argument("--root", required=True, help="Folder that contains 'CheXpert-v1.0-small'")
    parser.add_argument("--n", type=int, default=5000, help="How many images to sample")
    parser.add_argument("--seed", type=int, default=123, help="Random seed")
    parser.add_argument("--img-size", type=int, default=224, help="Resize/crop size")
    ...
    with open(args.csv, "r", newline="") as f:
        ...
        if "Path" not in reader.fieldnames:
            raise ValueError(f"CSV does not have a 'Path' column. Columns: {reader.fieldnames}")
    ...
    if total_pixels == 0:
        raise RuntimeError("No images were successfully loaded. Check your paths/root.")
