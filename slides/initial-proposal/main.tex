...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Can \textit{SimMIM} perform self-supervised representation learning of radiographs?
        \item If so, can the result be \textit{cheaply} finetuned to classify observations correctly?
    \end{itemize}
\end{itemize}
